...
description: Use when defining strategic outcomes, connecting roadmap deliverables to corporate objectives, planning measurable business results, or creating outcome issues that span multiple releases and teams.
---
...
- Guide outcomes through workflow states (Draft → Implementation → Evaluation → Closed)
...
**Outcome Creation Best Practices:**
...
**Title:** [Business Result] for [Stakeholder/Customer]
**Description:**
```
## Outcome Overview
[What measurable business result will be achieved? What customer/business behavior will change?]

## Customer Need / Business Context
[Why is this important? What problem does it solve? What opportunity does it capture?]
...
- **Metric 1**: [Specific measurement method]
- **Metric 2**: [Specific measurement method]
- **Metric 3**: [Specific measurement method]

## Expected Business Results
- [Tangible result 1: e.g., "15% increase in customer retention"]
- [Tangible result 2: e.g., "25% reduction in mean time to resolution"]
- [Tangible result 3: e.g., "50% increase in feature adoption rate"]

## Strategic Alignment
[How does this connect to Strategic Goals? Which corporate objectives does it support?]

## Key Deliverables (Features/Initiatives)
1. [Feature/Initiative 1]
2. [Feature/Initiative 2]
3. [Feature/Initiative 3]
...
## Dependencies
- [Dependency 1: e.g., "Requires Feature X from Team Y"]
- [Dependency 2: e.g., "Depends on completion of Initiative Z"]
...
- **Assignee**: [Primary owner accountable for outcome]
- **Contributors**: [Key stakeholders and delivery team members]
- **Stakeholders**: [Who needs to be informed/consulted]

## Post-Completion Review
[How will we evaluate whether the outcome was achieved? When will we review results?]
```
...
Outcomes typically exist in strategic projects:
- **HCMSTRAT**: Hybrid Cloud Management strategic outcomes
- **XCMSTRAT**: Cross-cloud strategic outcomes
- **SDSTRAT**: Engineering-driven strategic work
- **FRSTAT**: Feature-related strategic planning
- **CRCPLAN**: Customer and roadmap planning

Always verify the appropriate project for the outcome based on its scope and organizational context.
