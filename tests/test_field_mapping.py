...
class TestNewWritableFieldMappings:
    ...
    def test_qa_contact_mapping(self):
        ...
        assert fields["customfield_10470"] == {
            "accountId": "712020:76916d54-887a-4d7c-8898-6a4e91d98bb7"
        }
    ...
    def test_contributors_mapping(self):
        ...
        assert fields["customfield_10466"][0] == {
            "accountId": "712020:76916d54-887a-4d7c-8898-6a4e91d98bb7"
        }
        assert fields["customfield_10466"][1] == {
    ...
    def test_user_ref_accepts_opaque_ids(self):
        ...
        assert _user_ref("61fa7a56f5f5b80070c78e2c") == {
            "accountId": "61fa7a56f5f5b80070c78e2c"
        }
